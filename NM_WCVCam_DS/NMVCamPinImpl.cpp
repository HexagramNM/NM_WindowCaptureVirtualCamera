...
)
{
    *ppmt = CreateMediaType(&m_mt);
    ...
    pvi->bmiHeader.biWidth = VCAM_VIDEO_WIDTH;
    pvi->bmiHeader.biHeight = VCAM_VIDEO_HEIGHT;
    ...
    pvscc->InputSize.cx = VCAM_VIDEO_WIDTH;
    pvscc->InputSize.cy = VCAM_VIDEO_HEIGHT;
    pvscc->MinCroppingSize.cx = VCAM_VIDEO_WIDTH;
    pvscc->MinCroppingSize.cy = VCAM_VIDEO_HEIGHT;
    pvscc->MaxCroppingSize.cx = VCAM_VIDEO_WIDTH;
    pvscc->MaxCroppingSize.cy = VCAM_VIDEO_HEIGHT;
    pvscc->CropGranularityX = 80;
    pvscc->CropGranularityY = 60;
    pvscc->CropAlignX = 0;
    pvscc->CropAlignY = 0;

    pvscc->MinOutputSize.cx = VCAM_VIDEO_WIDTH;
    pvscc->MinOutputSize.cy = VCAM_VIDEO_HEIGHT;
    pvscc->MaxOutputSize.cx = VCAM_VIDEO_WIDTH;
    pvscc->MaxOutputSize.cy = VCAM_VIDEO_HEIGHT;
    ...
    pvscc->MinBitsPerSecond = (VCAM_VIDEO_WIDTH * VCAM_VIDEO_HEIGHT * PIXEL_BIT) / 5;
    pvscc->MaxBitsPerSecond = (VCAM_VIDEO_WIDTH * VCAM_VIDEO_HEIGHT * PIXEL_BIT) * 50;
